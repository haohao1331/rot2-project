...
def parse_log(log_file : Path):
    ...
    for i, line in enumerate(lines):
        ...
        elif re.match(r'mouse_est: -?\d+.\d+, -?\d+.\d+ | chip_est: -?\d+.\d+, -?\d+.\d+', line):
            floats = re.findall(r'\d+.\d+', line)
...
if __name__ == '__main__':
    log_file = Path(f'/Users/yefan/Desktop/rot2/rot2-project/data/2024-03-14_SC22/trial7/log.txt')
    output_dir = Path('/Users/yefan/Desktop/rot2/rot2-project/data/2024-03-14_fast_speed_analysis')

    parse_log(log_file).to_pickle(output_dir / f'2024-03-14_SC22_trial7.pkl')
    # df = pd.concat(dfs)
